...
graph TD
    ...
    H --> I[Dot Notation<br/>data:key::type]
    H --> J[Bracket Notation<br/>data&#91;'key'&#93;]
    H --> K[FLATTEN<br/>Arrays/Objects to Rows]

    G --> L[Auto-Columnarization]
    L --> M[Frequently Accessed Paths<br/>Stored Columnar]
    M --> N[Near-Relational<br/>Query Performance]
