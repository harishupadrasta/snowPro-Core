...
```mermaid
graph LR
    A[Active Data Current State] -->|Data modified/deleted| B[Time Travel 0-90 days User accessible]
    B -->|Retention expires| C[Fail-Safe 7 days Snowflake only]
    C -->|Fail-Safe expires| D[Data Permanently Purged]
