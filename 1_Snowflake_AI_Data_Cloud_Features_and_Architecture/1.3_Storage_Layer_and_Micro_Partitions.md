...
graph TD
    ...
    subgraph "Storage Layer — Micro-Partitions"
        direction LR
        MP1["MP-1 min:1, max:100 nulls:0"]
        MP2["MP-2 min:101, max:200 nulls:2"]
        MP3["MP-3 min:150, max:350 nulls:0"]
        MP4["MP-4 min:351, max:500 nulls:1"]
    end
    ...
    INS -->|"Writes immutable columnar files"| MP1
    INS --> MP2
    INS --> MP3
    INS --> MP4
