...
graph TB
    subgraph "Multi-Cluster Warehouse: ANALYTICS_WH"
        ...
        subgraph "Active Clusters"
            C1[Cluster 1 Running]
            C2[Cluster 2 Running]
        end
        
        subgraph "Standby / Scaled Out"
            C3[Cluster 3 Starting...]
            C4[Cluster 4 Suspended]
        end
    ...
    subgraph "Scaling Policies"
        direction LR
        SP["Standard Policy Start cluster when query queued Favors PERFORMANCE"]
        EP["Economy Policy Start cluster when 6 min load Favors COST SAVINGS"]
    end

    subgraph "Scaling Direction"
        UP["Scale UP ↑ Resize warehouse Faster individual queries"]
        OUT["Scale OUT → Add clusters More concurrent queries"]
    end
